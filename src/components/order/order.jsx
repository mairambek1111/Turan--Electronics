                ...
                <div className="order__wrap">
                    ...
                    <div className="order__content">
                        <div className="order__card">
                            ...
                            <div className="order__card__info">
                                <h1 className="order__card__title">
                                    Смартфон Apple Iphone 14 Pro <br /> max
                                    256GB
                                </h1>
                                <div className="order__card__quantity">
                                    <h2 className="order__card__quantity__minus">
                                        -
                                    </h2>
                                    <h2 className="order__card__quantity__nums">
                                        1
                                    </h2>
                                    <h2 className="order__card__quantity__plus">
                                        +
                                    </h2>
                                </div>
                            </div>
