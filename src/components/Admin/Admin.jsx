...
const Admin = () => {
    ...
    const h3 = document.querySelectorAll('.catalogH3')

    const addBlock = async (e) =>{
        e.target.style.color = 'red'
        setPathName(e.target.textContent)
                ...
                <div className="admin">
                    <div className="admin--bar">
                        <div className="admin--bar__log">
                            ...
                            <h1>Sanjar Kenjebekov</h1>
                        </div>
                        <div className="admin--bar__catalog">
                            <h3 className='catalogH3' onClick={(e)=>addBlock(e)}>Products</h3>
                            <h3 className='catalogH3' onClick={(e)=>addBlock(e)}>Favorite</h3>
                            <h3 className='catalogH3' onClick={(e)=>addBlock(e)}>Recomendation</h3>
                        </div>
                    </div>
                    <div className="admin--block">
                        <h1>{pathName}</h1>
                        <div className="admin--block__all">
                            {
                                catalog.map((el)=> <AdminCard el={el} key={el.id}/>)
                            }
                        </div>
                    </div>
                </div>
